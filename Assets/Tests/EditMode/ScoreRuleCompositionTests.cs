...
namespace MustyBlockBlast.Tests.EditMode
{
    ...
    public class ScoreRuleCompositionTests
    {
        ...
        public void PlacementScoreRule_MatchesScoreRulesFormula(int cellCount)
        {
            ...
            ScorePlacementContext context = new ScorePlacementContext(cellCount, 0, 0, 0);
        ...
        public void LineClearScoreRule_MatchesScoreRulesFormula(int linesCleared, int streak)
        {
            ...
            ScorePlacementContext context = new ScorePlacementContext(4, linesCleared, streak, 0);
        ...
        public void LineClearScoreRule_NoLinesCleared_IsZero()
        {
            ...
            Assert.AreEqual(0, rule.ComputeBonus(new ScorePlacementContext(4, 0, 3, 0)));
        }
        ...
        public void MonochromeScoreRule_MatchesTheManualFormula(int linesCleared, int monochromeLineCount)
        {
            ...
            ScorePlacementContext context = new ScorePlacementContext(4, linesCleared, 0, monochromeLineCount);
        ...
        public void MonochromeScoreRule_MixedColourLines_IsZero()
        {
            ...
            Assert.AreEqual(0, rule.ComputeBonus(new ScorePlacementContext(4, 2, 3, 0)));
        }
        ...
        public void MonochromeScoreRule_NoLinesCleared_IsZero()
        {
            ...
            Assert.AreEqual(0, rule.ComputeBonus(new ScorePlacementContext(4, 0, 3, 2)));
        }
