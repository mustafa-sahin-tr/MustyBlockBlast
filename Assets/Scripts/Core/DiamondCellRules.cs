namespace MustyBlockBlast.Core
{
    ...
    public static class DiamondCellRules
    {
        ...
        /// <see cref="SpecialCellKind"/> (a timer cell most of all) or any reinforcement hits, in which
        /// case the cell is placed as an ordinary block of the piece's colour instead.
        /// </summary>
