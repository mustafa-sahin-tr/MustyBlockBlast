...
namespace MustyBlockBlast.Gameplay.Settings
{
    ...
    /// retuned.
    /// <para>
    /// A table keyed by kind rather than nine named fields. The roster grows (it has grown from three
    /// kinds to nine), and a table adds a row where nine fields would add a field, a property and a
    /// branch. It is also the shape the enum already persists in — see <c>PowerUpInventoryKey</c> —
    ...
    public sealed class PowerUpPriceConfig : ScriptableObject
    {
        ...
        /// rather than nine unbuyable rows.
        /// </summary>
        [Header("Prices")]
        ...
        /// <para>
        /// A linear scan over nine rows. Never called per frame — a purchase and a shop repaint are
